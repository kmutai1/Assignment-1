...
>>> power_using_iteration(5, 0)
1

>>> power_using_iteration(3, 3)
27

>>> power_using_iteration(3.0, 3)  # note that the ".0" is retained in the answer
27.0

>>> power_using_iteration(1.5, 2)   # 3/2 squared is 9/4
2.25
...
>>> power_using_iteration(0.9, 5)  # doctest: +ELLIPSIS
0.5904900...

Testing for exceptions, read the following for further explaination on how to doctest exception
# https://docs.python.org/2.4/lib/doctest-exceptions.html
>>> power_using_iteration("2", 5)
Traceback (most recent call last):
TypeError: Base should be either integer or float

>>> power_using_iteration(2, 0.5)
Traceback (most recent call last):
